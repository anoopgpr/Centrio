...
var lastattemptpage = '';
var filenm='';
var json_fb='https://taghash.co/mloyalApps/facebookcentriomall.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=centriomall';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinterest612league.php?brand=centriomall';
var RSS_instagram='https://www.instagram.com/centriomall/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=centriomall';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://centriomall.tumblr.com';
var RSS_matchfix = 'http://xceedfbapps.com/ddfeeds/calendar_new.php';//'http://xceedfbapps.com/ddfeeds/myxml.php';
var json_news = 'http://180.179.202.114:82/centriomall/press_json.jsp';//'http://xceedfbapps.com/mloyalfeeds/divani.php';
var json_gal = 'http://180.179.202.114:82/centriomall/gallery_json.jsp';
var brandname = 'centriomall';
var aboutus_det = 'centrio mall';
var brand_url = 'http://centriomall.in/';
var cart = {cartdata: []};
...
user = {
	...
	"dob":"",
	"slabid_centriomall": "",
	"slabname_centriomall": ""
};

var SERVER = "https://centriomall.mloyalretail.com/m/"; 
var SERVER1 = "https://centriomall.mloyalretail.com/";
var SERVER2 = "https://centriomall.mloyalretail.com/APIs/";
...
$(document).ready(function (event) {
	...
	/*$.ajax({
   url: 'http://180.179.218.225:82/centriomall/logixhomepage2.jsp',
   type: 'GET',
   timeout: 30000,
     data: {
            },
   ...
   error: function(xhr, textStatus, errorThrown) {
    ...
    //getContacts();
  //  console.log("usernamecentriomall:"+localStorage.getItem("usernamecentriomall"));
				if(localStorage.getItem("usernamecentriomall")!=null && localStorage.getItem("usernamecentriomall")!='' && localStorage.getItem("passwordcentriomall")!=null && localStorage.getItem("passwordcentriomall")!='')
                    {
                           $('#username_p').val(localStorage.getItem("usernamecentriomall"));
                           $('#password_myacc').val(localStorage.getItem("passwordcentriomall"));
							user.mobile=localStorage.getItem("usernamecentriomall");
							authenticate();
                                                
                     }
				 else if(localStorage.getItem("usernamecentriomall")!=null && localStorage.getItem("usernamecentriomall")!='' && (localStorage.getItem("passwordcentriomall")==null || localStorage.getItem("passwordcentriomall")=='')) 
	                 {
					   $('#username_p').val(localStorage.getItem("usernamecentriomall"));
...
{
	localStorage["interestcentriomall"] ='';
	arr=[];
...
$(document).on('pageinit', '#interest', function () {
	 ...
	 $(document).on('tap', '#next_int', function (e, ui) {
		 ...
		 localStorage.setItem("profiledone_centriomall", "Yes");
		...
		localStorage["interestcentriomall"] = JSON.stringify(arr);
		//localStorage.setItem("interestcentriomall", arr);
...
{
	if(localStorage["interestcentriomall"])
		arr = JSON.parse(localStorage["interestcentriomall"]);
        ...
        $.ajax({
            ...
            success: function (data, textStatus, xhr) {
                ...
                if (data.indexOf("Success") >= 0)
                {
                    ...
                    localStorage.setItem("usernamecentriomall", mobile);
                    ...
                    localStorage.setItem("usernamecentriomall_name", user.firstname);
                    if(postregister!='')
					{
...
function showTabContent(id, url) {
    ...
    {
        tabserver = "https://centriomall.mloyalretail.com/Rewards/";
    }
    else
    {

        tabserver = "https://centriomall.mloyalretail.com/m/";
    }
    $.getJSON(
            tabserver + url, {
                //page: url,
    ...
    switch (pageID) {
        ...
        case 'coupons':
			...
			else
			{
				for(var i=0;i<json.data.length;i++)
				{
					...
					str += '<span class="MsgBdr"><span class="msghdr">DM-CENTRIO</span><span class="msgTime"> '+json.data[i].issueddate+'</span>'; 
        ...
        case 'inbox':
		 ...
		 for(var i=0;i<json.length;i++ )
			...
			str += '<span class="msghdr">DM-CENTRIO</span><span class="msgTime">'+json[i].msgtime+'</span>'; 
        ...
        case 'collections':
			...
			try{
				$('#dircaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("1");
		   ...
		   for (var i = 0; i < json.data.length; i++)
			...
			try{
			$('#htcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("2");
		   ...
		   for (var i = 0; i < json.data.length; i++)
			...
			try{
			$('#pvrcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("3");
			...
			try{
			$('#atcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("4");
		   ...
		   for (var i = 0; i < json.data.length; i++)
			...
			try{
			$('#fbcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("5");
		//	$('#fblogo'+(i+1)).click( createCallback(bi,json,i,pageID) );
			...
			try{
			$('#fdcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("5");
		//	$('#fblogo'+(i+1)).click( createCallback(bi,json,i,pageID) );
			}
			...
			str = '';
            console.log("fgourmetonline:"+JSON.stringify(json));
		    ...
		    for (var i = 0; i < json.data.length; i++)
					{
					  ...
					  bi = json.data[i].brandid;
					   ...
					   bcon=json.data[i].brandcontent.replace(new RegExp('\'', 'g'), '');
			            ...
			            $('#bl_fd_gourmnt'+(i+1)).attr('href','javascript:showBrandDetail(\''+bi+'\' ,\''+ pageID+'\' ,\''+ json.data[i].brandname+'\' ,\''+ bcon+'\' ,\''+ json.data[i].brandfloor+'\' ,\''+ json.data[i].brandlogo+'\',\''+ json.data[i].block+'\' ,\''+ timing+'\',\''+ json.data[i].brandshopno+'\',\''+ json.data[i].brandcontactperson+'\',\''+ json.data[i].brandcontactnumber+'\',\''+ json.data[i].menuImage1+'\',\''+ json.data[i].menuImage2+'\',\''+ json.data[i].menuImage3+'\',\''+ json.data[i].menuImage4+'\',\''+ json.data[i].menuImage5+'\',\''+ json.data[i].restaurantImage1+'\',\''+ json.data[i].restaurantImage2+'\',\''+ json.data[i].restaurantImage3+'\',\''+ json.data[i].restaurantImage4+'\',\''+ json.data[i].restaurantImage5+'\',\''+ json.data[i].floor_image+'\');');


			
			
			document.getElementById("fdlogo_gourmnt"+(i+1)).src= json.data[i].brandlogo;
			document.getElementById("fdcaption_gourmnt"+(i+1)).innerHTML=json.data[i].brandname;
			if(json.data[i].brandlogo=='' || json.data[i].brandlogo== 'undefined' ||json.data[i].brandlogo=='null' ||json.data[i].brandlogo==null){
				document.getElementById("fdlogo_gourmnt"+(i+1)).src= 'images/banner/logo.jpg';
			}
			try{
			$('#blankfdarea_gourmnt'+i).css('background-color','#ffffff');
			}catch(err){ }
			try{
			$('#fdcaption_gourmnt'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("5");
		//	$('#fblogo'+(i+1)).click( createCallback(bi,json,i,pageID) );
			}
			...
			for (var i = json.data.length; i < 84; i++)
			{ 
				document.getElementById("fdlogo_gourmnt"+(i+1)).src= 'images/banner/blank.jpg';
				document.getElementById("fdcaption_gourmnt"+(i+1)).innerHTML='';
				$('#blankfdarea_gourmnt'+(i+1)).css('display','none');
		   ...
		   for (var i = 0; i < json.data.length; i++)
		   {
			...
			try{
			$('#shcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("6");
		   ...
		   for (var i = 0; i < json.data.length; i++)
			...
			try{
			$('#evtcaption'+(i+1)).css('background-color','#e09132');
			}catch(err){ }
			//alert("7");
...
function resetPage()
{
	...
	for (var i=1;i<84;i=i+2 )
	{
		...
		try{
            ...
            document.getElementById("fdlogo_gourmnt"+(i+1)).src= 'images/banner/logo.jpg';
            document.getElementById("fdlogo_gourmnt"+(i)).src= 'images/banner/blank.jpg';
            document.getElementById("fdcaption_gourmnt"+(i+1)).innerHTML='';
            document.getElementById("fdcaption_gourmnt"+(i)).innerHTML='';
            try{
            $( "#fdlogo_gourmnt"+i).unbind( "click" );
            }catch(err){ }
            try{
            $('#blankfdarea_gourmnt'+i).css('background-color','#f7f7f7');
            }catch(err){ }
            try{
                $('#fdcaption_gourmnt'+i).css('background-color','#f7f7f7');
                $('#fdcaption_gourmnt'+(i+1)).css('background-color','#f7f7f7');
                }catch(err){ }
...
function createCallback(bi,json,i,cat){
  return function(){
   ...
   var timing;
	...
	//{"brandid":11,"brandname":"Toscano","brandcontent":"Toscano Restaurant & Wine Bar is a fine-dining Italian restaurant that offers an intimate yet vibrant atmosphere fusing the best of old and new world Italian cuisine.\r\n\r\nAn eclectic menu of gourmet pizzas, multi-course dinners & extensive range of wines enables the perfect pairing with your meal. Toscano strives to offer the same relentless signature perseverance for quality and excellence in all that we do.","brandlogo":"https://centriomall.mloyalretail.com/Rewards/brands/toscano-logo.jpg","brandfloor":"Third Floor","brandshopno":"11","brandcontactperson":"","brandcontactnumber":"","categoryid":14}
...
function showBrandDetail(bi , cat , brandname , brandcontent , brandfloor , brandlogo , brandblk, brandtime, brandshopno, brandcontactperson, brandcontactnumber, menuimage1, menuimage2, menuimage3, menuimage4, menuimage5, restaurantimage1, restaurantimage2, restaurantimage3, restaurantimage4, restaurantimage5, floorimage)
{
	...
	else
	{
		...
		if(brandcontactperson=='' || brandcontactperson=='undefined' || brandcontactperson=='null' || brandcontactperson==null)
	    brandcontactperson = '';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_centriomall',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_centriomall')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_centriomall',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_centriomall')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_centriomall', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_centriomall')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_centriomall',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_centriomall')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_centriomall',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_centriomall')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_centriomall',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_centriomall')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function addincart(i)
{
    ...
    cart.cartdata.push({
        "index": i,
        "url": "https://centriomall.mloyalretail.com/" + jsonary[i].brand_logo,
...
function checkout() {
    ...
    $.ajax({
        url: 'https://centriomall.mloyalretail.com/Rewards/complete.asp',
        type: 'GET',
        timeout: 50000,
...
function showShop() {
    ...
    var str1 = '';
    str1 = '<embed src="http://centriomall.in/" width=' + the_width + ' height=' + the_height + ' /></embed>';
...
function giftfriend() {
    ...
    var val = $('#giftpt').val();
    $.ajax({
        url: 'https://centriomall.mloyalretail.com/m/gift_points_api.asp',
        type: 'GET',
        timeout: 50000,
        dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
    window.plugins.socialsharing.share('Hi, Join Centrio Loyalty Rewards.', null, 'https://taghash.co/shareimg/centriomall.png', 'https://centriomall.mloyalretail.com/mapp');
}
...
function rateApp()
{
    ...
    {
		window.open("market://details?id=com.mobiquest.centriomall","_system");
    }
...
function showTNC()
{
    //openInWebView('https://centriomall.mloyalretail.com/microsite/terms_condition.asp');
    $.mobile.changePage("#innershop", {transition: "flip"});
    var the_height = ($(window).height() - $(this).find('[data-role="header"]').height());
    var the_width = $(window).width();
    var str1 = '';
    str1 = '<embed src="https://centriomall.mloyalretail.com/microsite/tnc.asp" width=' + the_width + ' height=' + the_height + ' /></embed>';
    $("#innershop .ui-content").html(str1);
}
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "205914457312"}});
...
function openurl()
{
    ...
    openInWebView('http://centriomall.in/');
...
function bookCab()
{
	...
	var ref = window.open('https://book.olacabs.com/', '_blank', 'location=yes,toolbar=yes');
}
...
function senddata(activity)
{
 ...
 var uname = localStorage.getItem('usernamecentriomall');
 ...
 if(uname==null || uname=='undefined' || uname=='null' || uname=='')
  ...
  $.ajax({
   ...
   url: 'https://centriomall.mloyalretail.com/m/mloyalactivity_json.asp', //login.php
   type: 'GET',
   timeout: 50000,
...
function showshoppinginner(shcatname)
{
   ...
   showTabContent_json_brand('shopping',shcatname);
    if(shcatname=='1029')
	{
    document.getElementById('acatname').innerHTML='Accessories';
	category_nm='Category- Accessories';
	}
	else if(shcatname=='1028')
	{
	document.getElementById('acatname').innerHTML='Beauty & Skincare';
	category_nm='Category- Beauty & Skincare';
	}
	else if(shcatname=='1030')
	{
	document.getElementById('acatname').innerHTML='Footwear';
	category_nm='Category- Footwear';
	}
	else if(shcatname=='1027')
	{
    document.getElementById('acatname').innerHTML='Home & Lifestyle';
	category_nm='Category- Home & Lifestyle';
	}
	else if(shcatname=='1033')
	{	
    document.getElementById('acatname').innerHTML='Kids Fashion';
	category_nm='Category- Kids Fashion';
	}
	else if(shcatname=='1031')
	{	
    document.getElementById('acatname').innerHTML='Mens Fashion';
	category_nm='Category- Mens Fashion';
	}
	else if(shcatname=='1032')
	{
    document.getElementById('acatname').innerHTML='Womens Fashion';
	category_nm='Category- Womens Fashion';
	}
	/*else if(shcatname=='1')
	{
	...
	{	
    document.getElementById('acatname').innerHTML='Sports';
	category_nm='Category- Sports';
	}
...
$(document).on('pagebeforeshow', '#FoodBox', function () {
	//alert("here");
	  ...
	  category_nm='Category- Food Court';
	  });

$(document).on('pagebeforeshow', '#gourmet', function () {
        //alert("here");
        gourmnt();
    
       currentcategory='gourmet';
       category_nm='Category- Gourmet Online';
    });      
...
$(document).on('pagebeforeshow', '#FineDining', function () {
	//alert("here");
	  ...
	  category_nm='Category- Cafes & Restaurants';
	  });	 
...
$(document).on('pagebeforeshow', '#PVR_Entertainment', function () {
  ...
  function showTabContent_json_brand(id,catid) {
    ...
    var tabserver='https://centriomall.mloyalretail.com/APIs/brands_json.asp';
...
function showTabContent_json_events(id) {
    ...
    var tabserver='https://centriomall.mloyalretail.com/APIs/geteventsdetails_json.asp';
	//alert("there"+tabserver);	
	 $.getJSON(
            tabserver , {
				'apiuid' : 'MLOYALAPI',
...
function showTabContentNew(id, url) {
	...
	{
		tabserver = "https://centriomall.mloyalretail.com/APIs/";
	}
...
{
	//openInWebView('https://centriomall.mloyalretail.com/microsite/');
	var ref = window.open('https://centriomall.mloyalretail.com/microsite/', '_blank', 'location=yes,toolbar=yes');
}
...
$(document).on('pageshow', '#bill_upload', function () {
	...
	{
	     $('#TxtMobile').val(localStorage.getItem("usernamecentriomall"));
...
function upload_bill()
{
		...
		{
			$.ajax({
			url: 'https://centriomall.mloyalretail.com/apis/cust_pending_bills_json_api.asp',
			type: 'GET',
			timeout: 30000,
		  	data: {
...
/* uploading bill image to server */
		  ...
		  function capturePhoto() {
			...
			function uploadPhoto(imageURI) {
				...
				var fName=user.mobile+'_'+Math.floor((Math.random() * 100000000) + 1);
				//var fName='profile_'+user.mobile;
				options.fileName= fName;
				options.mimeType="image/jpeg";
				options.mimeType="image/png";
				filenm='https://taghash.co/centriomall/uploads/'+options.fileName+'.jpg';
                ...
                // https://taghash.co/centriomall/upload_photo_new.php
				// ft.upload(imageURI, encodeURI("http://180.179.202.114:8383/centriomall/upload_bill_new.php"), win, fail, options, true);
                ft.upload(imageURI, encodeURI("https://taghash.co/centriomall/upload_photo_new.php"), win, fail, options, true);
			}
...
function showFloor(flr)
{
	...
	if(flr=='LGF')
	{
		...
		zmImage.src = 'https://taghash.co/centriomallnew/floors/LEASED_LGF.png';
	...
	else if(flr=='GF')
	{
		...
		zmImage.src = 'https://taghash.co/centriomallnew/floors/LEASED_UGF.png';
		$.mobile.changePage("#floorplan", {transition: "none"});
	}
	else if(flr=='FF')
	{
		...
		zmImage.src = 'https://taghash.co/centriomallnew/floors/LEASED_FIRST-FLOOR.png';
		$.mobile.changePage("#floorplan", {transition: "none"});
	}
	else if(flr=='SF')
	{
		...
		zmImage.src = 'https://taghash.co/centriomallnew/floors/LEASED_SECOND-FLOOR.png';
		$.mobile.changePage("#floorplan", {transition: "none"});
	}
	else if(flr=='TF')
	{
		...
		zmImage.src = 'https://taghash.co/centriomallnew/floors/LEASED_THIRD-FLOOR.png';
		$.mobile.changePage("#floorplan", {transition: "none"});
	}
		 ...
		 $.ajax({
			...
			success: function(data, textStatus, xhr) {
			 ...
			 if(data.toLowerCase()=='success'){
			      ...
			      $('#username_p').val(mob);
				  localStorage.setItem('usernamecentriomall',mob);
				  $.mobile.changePage("#profilepage");
              }
			  else{
...
function authenticate()
{
  ...
  var phno = localStorage.getItem("usernamecentriomall");
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   if(data.status=='success'){
	...
	user.slabid_centriomall = checkforundefined(data.slabid);
	user.slabname_centriomall = checkforundefined(data.slabname);
	user.def_store = checkforundefined(data.store);
	user.def_city = checkforundefined(data.store_city);
	user.visit_frequency = checkforundefined(data.visit_frequency);
   ...
   localStorage.setItem('usernamecentriomall',uname);
   localStorage.setItem('passwordcentriomall',pwd);
   ...
   localStorage.setItem('slabid_centriomall',user.slabid_centriomall);
 ...
 if(user.firstname == '')
	   {
        ...
        localStorage.setItem("profiledone_centriomall","No");
	   }
	    var dob = user.dob.split('-');
	...
	if(imageExists('https://taghash.co/centriomall/uploads/photo_'+localStorage.getItem("usernamecentriomall")+'.jpg'))
		{
			user.p_photo = 'https://taghash.co/centriomall/uploads/photo_'+localStorage.getItem("usernamecentriomall")+'.jpg'; 
	...
	var s1 = parseInt(user.balance);
			...
			else if(s1 >= 150001)
			{
			 ...
			 if(localStorage.getItem("profiledone_centriomall")=='Yes')
			 {
    ...
    error: function(xhr, textStatus, errorThrown) {
	user.mobile = localStorage.getItem('usernamecentriomall');
	pwd = localStorage.getItem('passwordcentriomall');
	uname = user.mobile;
...
{
				var b_Image1 = document.getElementById('cardImagemenu');
				...
				file_pphoto="https://taghash.co/centriomall/uploads/"+options.fileName+".jpg";
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/centriomall/upload_photo_new.php"), win, failPhoto4, options, true);
}
...
function showOffers()
{
	$.mobile.changePage("#rewardsmain", {transition: "none"});
     ...
     var tabserver='https://taghash.co/centriomallnew/getoffers.php';
	//alert("there"+tabserver);	
	 $.getJSON(
            tabserver , {  }, 
		     function (json) {
...
/*function gotContacts(contacts) {
                    ...
                    for(var i=0, len=contacts.length; i<len; i++) {
                        ...
                        url:'https://centriomall.mloyalretail.com/apis/mycontacts_json.asp?Bulkdata='+contacts[i].displayName+':'+phno,
...
function showhomePage2()
{
  ...
  $.ajax({
   url: 'https://taghash.co/centriomall/centriomall_homepage2.php',
   type: 'GET',
   timeout: 30000,
     data: {
            },
...
function showEntertainment()
{
	  ...
	  for (var i = 0; i < 84; i++)
		...
		showTabContent_json_brand('PVR_Entertainment','1034');
...
function gourmnt()
{
	  ...
	  for (var i = 0; i < 84; i++)
			{ 
				document.getElementById("fdlogo_gourmnt"+(i+1)).src= 'images/banner/blank.jpg';
				document.getElementById("fdcaption_gourmnt"+(i+1)).innerHTML='';
				$('#blankarea_gourmnt'+(i+1)).css('display','block');
			
			}

	 
	    showTabContent_json_brand('gourmetonline','1039');  
...
function showFood()
{
	  ...
	  for (var i = 0; i < 84; i++)
	    ...
	    showTabContent_json_brand('foodbox','1036');
...
function showFood2()
{
	  ...
	  for (var i = 0; i < 84; i++)
	    ...
	    showTabContent_json_brand('finedining','1035');
...
function showVouchers()
{
	  ...
	  $.ajax({
	   ...
	   url: 'https://centriomall.mloyalretail.com/apis/get_voucher_details_json_api.asp',
	   type: 'GET',
	   timeout: 50000,
		dataType: 'json',
...
$(document).on('pageinit', '#homePage', function (event, ui) {
      ...
      if(typeof localStorage.getItem('selectedstore')!=undefined && localStorage.getItem('selectedstore')!=null && localStorage.getItem('selectedstore')!='')
	   ...
	   {
		   document.getElementById("ambiloc").innerHTML= 'centrio mall';
	   }
...
{
    var ref = window.open('http://centriomall.in/magazine/vivi-Issue9.pdf', target="_new", 'location=yes,toolbar=yes');
...
{
	window.plugins.socialsharing.share( bname, null, blogo, 'http://centriomall.in');
}
...
if(user.mobile==null || user.mobile=='')
	...
	$.ajax({
	   ...
	   url: 'https://centriomall.mloyalretail.com/APIs/get_bonuspoints_json_api.asp',
	   type: 'GET',
	   timeout: 50000,
		dataType: 'json',
		...
		if(data.data.length>0)
			{
				...
				user.slabid_centriomall = data.data[0].slabid;
